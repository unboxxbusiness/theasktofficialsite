      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            <h3 className="text-2xl font-bold text-center md:text-left">Perfect For</h3>
          ...
          <div className="space-y-8">
             <div className="p-6 bg-card rounded-lg border">
                <h3 className="text-2xl font-bold mb-6 text-center md:text-left">What You Will Learn</h3>
              ...
              <div className="p-6 bg-card rounded-lg border">
                <h3 className="text-2xl font-bold mb-6 text-center md:text-left">What You Get</h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                  ...
                  <li className="flex items-center gap-3">
                    <HeartHandshake className="h-5 w-5 text-accent flex-shrink-0" />
